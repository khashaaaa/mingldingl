...
import { ACCENT, COLORS, FONTS, FONT_SIZES, ICON_SIZES, INK, LINE_HEIGHTS, METAL, RADIUS, SPACE, overlay } from '../../lib/theme';
...
export function AlertModal({
  ...
  const tint = tone === 'warning' ? METAL.ember : ACCENT.base;
